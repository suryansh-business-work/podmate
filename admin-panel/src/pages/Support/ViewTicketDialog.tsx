...
import {
  ...
  Box, Typography, Chip, Card, Button, TextField, CircularProgress, Divider,
} from '@mui/material';
...
const ViewTicketDialog: React.FC<ViewTicketDialogProps> = ({ ticket, onClose, onReply, onRefetch }) => {
  ...
  return (
    <Dialog open={Boolean(ticket)} onClose={handleClose} maxWidth="sm" fullWidth>
        ...
        {ticket && (
          <Box>
            ...
            {ticket.replies && ticket.replies.length > 0 && (
              <>
                <Divider sx={{ my: 2 }} />
                <Typography variant="subtitle2" fontWeight={600} mb={1}>Conversation</Typography>
                    ...
                    return (
                      ...
                      >
                        <Box display="flex" alignItems="center" gap={0.5} mb={0.5}>
                          {isAdmin ? <AdminPanelSettingsIcon sx={{ fontSize: 14 }} /> : <PersonIcon sx={{ fontSize: 14 }} />}
            ...
            <Divider sx={{ my: 2 }} />
            <Typography variant="subtitle2" fontWeight={600} mb={1}>Reply</Typography>
            <TextField
              fullWidth
              multiline
              rows={3}
      ...
      <DialogActions>
        ...
        <Button variant="outlined" onClick={() => { if (ticket) onReply(ticket); handleClose(); }}>Edit Ticket</Button>
        <Button
          variant="contained"
