...
const EditTicketDialog: React.FC<EditTicketDialogProps> = ({
  ticket, replyText, newStatus, newPriority, updating,
  onReplyChange, onStatusChange, onPriorityChange, onSave, onClose,
}) => (
    ...
    <DialogContent>
      {ticket && (
        <Box>
          ...
          <TextField select fullWidth label="Status" value={newStatus} onChange={(e) => onStatusChange(e.target.value)} sx={{ mb: 2, mt: 1 }}>
            <MenuItem value="OPEN">Open</MenuItem>
            <MenuItem value="IN_PROGRESS">In Progress</MenuItem>
            <MenuItem value="RESOLVED">Resolved</MenuItem>
            <MenuItem value="CLOSED">Closed</MenuItem>
          </TextField>
          <TextField select fullWidth label="Priority" value={newPriority} onChange={(e) => onPriorityChange(e.target.value)} sx={{ mb: 2 }}>
            <MenuItem value="LOW">Low</MenuItem>
            <MenuItem value="MEDIUM">Medium</MenuItem>
            <MenuItem value="HIGH">High</MenuItem>
          </TextField>
          <TextField fullWidth multiline rows={4} label="Admin Reply" value={replyText} onChange={(e) => onReplyChange(e.target.value)} />
        </Box>
      )}
    </DialogContent>
    <DialogActions>
