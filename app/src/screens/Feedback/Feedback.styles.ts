...
export const styles = StyleSheet.create({
  ...
  typeLabel: { fontSize: 11, fontWeight: '600', color: colors.primary, textTransform: 'uppercase' },
  feedbackTitle: { fontSize: 15, fontWeight: '600', color: colors.text, marginBottom: spacing.xs },
  ...
  adminNotesLabel: { fontSize: 11, fontWeight: '600', color: colors.accent, marginTop: spacing.sm },
