      ...
      {({ handleChange, handleBlur, handleSubmit, values, errors, touched, setFieldValue }) => (
        ...
        >
              ...
              >
                <Text
                  style={[
                    ...
                    values.category === cat && styles.categoryBtnTextActive,
                  ]}
                >
                  {cat}
                </Text>
          ...
          <Text style={styles.helperText}>
            Upload photos and videos of your venue to attract guests. At least one image is
            recommended.
          </Text>
          <MediaUploader
          ...
          <VenueLocationPicker
            ...
            onLocationChange={({ address, city, state, country, pincode, latitude, longitude, placeId }) => {
              ...
              if (country !== undefined) setFieldValue('country', country);
