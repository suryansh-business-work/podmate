...
export const styles = StyleSheet.create({
  ...
  sessionDesc: { fontSize: 13, color: colors.textSecondary, lineHeight: 18, marginBottom: spacing.md },
  joinBtn: {
  ...
  startedAt: { fontSize: 11, color: colors.textTertiary, marginTop: spacing.sm, textAlign: 'right' },
