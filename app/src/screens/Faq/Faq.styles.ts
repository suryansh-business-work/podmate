...
const createStyles = ({ colors, spacing, borderRadius }: ThemeUtils) => StyleSheet.create({
  ...
  callbackTitle: { fontSize: 18, fontWeight: '700', color: colors.text, marginBottom: spacing.xs },
  callbackSubtitle: { fontSize: 14, color: colors.textSecondary, marginBottom: spacing.xl, lineHeight: 20 },
  inputLabel: { fontSize: 12, fontWeight: '600', color: colors.text, letterSpacing: 0.5, marginBottom: spacing.xs, marginTop: spacing.md },
  textInput: {
