    ...
    <View style={styles.logisticsRow}>
      ...
      <View style={styles.logisticsItem}>
        ...
        <View style={styles.counterRow}>
          <TouchableOpacity style={styles.counterButton} onPress={() => onMaxSeatsChange(Math.max(1, maxSeats - 1))}>
            <Text style={styles.counterButtonText}>−</Text>
          </TouchableOpacity>
          <Text style={styles.counterValue}>{maxSeats}</Text>
          <TouchableOpacity style={styles.counterButton} onPress={() => onMaxSeatsChange(maxSeats + 1)}>
            <Text style={styles.counterButtonText}>+</Text>
          </TouchableOpacity>
        </View>
      </View>
