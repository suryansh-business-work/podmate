        ...
        <CardContent>
          ...
          <TabPanel value={tab} index={0}>
            ...
            <Stack direction="row" justifyContent="flex-end" spacing={2} mt={3}>
              <Button
                variant="outlined"
                startIcon={testingSmtp ? <CircularProgress size={18} /> : <NetworkCheckIcon />}
          ...
          <TabPanel value={tab} index={1}>
            ...
            <Stack spacing={2}>
              <TextField
                ...
                onChange={(e) => setImagekit((p) => ({ ...p, publicKey: e.target.value }))}
                fullWidth
              />
              <TextField
                label="Private Key"
                ...
                onChange={(e) => setImagekit((p) => ({ ...p, privateKey: e.target.value }))}
                fullWidth
              />
              <TextField
                label="URL Endpoint"
                value={imagekit.urlEndpoint}
                onChange={(e) => setImagekit((p) => ({ ...p, urlEndpoint: e.target.value }))}
                fullWidth
              />
            </Stack>
            <Stack direction="row" justifyContent="flex-end" spacing={2} mt={3}>
              <Button
                variant="outlined"
                startIcon={testingImageKit ? <CircularProgress size={18} /> : <NetworkCheckIcon />}
          ...
          <TabPanel value={tab} index={2}>
            ...
            <Stack spacing={2}>
              ...
              <TextField
                label="Channel"
                value={slack.channel}
                onChange={(e) => setSlack((p) => ({ ...p, channel: e.target.value }))}
                fullWidth
              />
              <FormControlLabel
                control={
                  <Switch
                    checked={slack.enabled === 'true'}
                    onChange={(e) =>
                      setSlack((p) => ({ ...p, enabled: e.target.checked ? 'true' : 'false' }))
                    }
                  />
                }
          ...
          <TabPanel value={tab} index={3}>
            ...
            <Stack spacing={2}>
              <TextField
                ...
                onChange={(e) => setStripe((p) => ({ ...p, publishableKey: e.target.value }))}
                fullWidth
              ...
              <TextField
                ...
                onChange={(e) => setStripe((p) => ({ ...p, secretKey: e.target.value }))}
                fullWidth
              ...
              <TextField
                ...
                onChange={(e) => setStripe((p) => ({ ...p, webhookSecret: e.target.value }))}
                fullWidth
              ...
              <FormControlLabel
                control={
                  <Switch
                    checked={stripe.enabled === 'true'}
                    onChange={(e) =>
                      setStripe((p) => ({ ...p, enabled: e.target.checked ? 'true' : 'false' }))
                    }
                  />
                }
          ...
          <TabPanel value={tab} index={4}>
            ...
            <Stack spacing={2}>
              <TextField
                ...
                onChange={(e) => setGoogleMaps((p) => ({ ...p, apiKey: e.target.value }))}
                fullWidth
              ...
              <FormControlLabel
                control={
                  <Switch
                    checked={googleMaps.enabled === 'true'}
                    onChange={(e) =>
                      setGoogleMaps((p) => ({ ...p, enabled: e.target.checked ? 'true' : 'false' }))
                    }
                  />
                }
          ...
          <TabPanel value={tab} index={5}>
            ...
            <Stack spacing={2}>
              ...
              <TextField
                ...
                onChange={(e) => setAppConfig((p) => ({ ...p, appDescription: e.target.value }))}
                fullWidth
                multiline
                rows={2}
              />
              <TextField
                label="App Logo URL"
                value={appConfig.appLogo}
                onChange={(e) => setAppConfig((p) => ({ ...p, appLogo: e.target.value }))}
                fullWidth
                helperText="Upload via ImageKit and paste the URL"
              />
              <TextField
                label="Splash Video URL"
                value={appConfig.splashVideoUrl}
                onChange={(e) => setAppConfig((p) => ({ ...p, splashVideoUrl: e.target.value }))}
                fullWidth
          ...
          <TabPanel value={tab} index={6}>
            ...
            <Stack spacing={2}>
              <FormControlLabel
                control={
                  <Switch
                    checked={devConfig.devMode === 'true'}
                    onChange={(e) =>
                      setDevConfig((p) => ({ ...p, devMode: e.target.checked ? 'true' : 'false' }))
                    }
                  />
                }
              ...
              <FormControlLabel
                control={
                  <Switch
                    checked={devConfig.dummyCheckout === 'true'}
                    onChange={(e) =>
                      setDevConfig((p) => ({
                        ...p,
                        dummyCheckout: e.target.checked ? 'true' : 'false',
                      }))
                    }
                  />
                }
