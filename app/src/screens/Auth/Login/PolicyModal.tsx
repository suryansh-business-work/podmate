...
const PolicyModal: React.FC<PolicyModalProps> = ({ policyType, onClose }) => {
  ...
  return (
    <Modal visible={!!policyType} animationType="slide" transparent testID="policy-modal">
