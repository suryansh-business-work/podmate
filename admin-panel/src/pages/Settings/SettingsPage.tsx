...
import {
  ...
  Button, CircularProgress, Alert, Breadcrumbs, Link, Divider,
} from '@mui/material';
import HomeIcon from '@mui/icons-material/Home';
import AddIcon from '@mui/icons-material/Add';
import { useQuery, useMutation } from '@apollo/client';
import { GET_APP_SETTINGS, GET_MAINTENANCE_MODE } from '../../graphql/queries';
import { UPSERT_SETTING, DELETE_SETTING } from '../../graphql/mutations';
import { AppSetting, SettingsData, MaintenanceData } from './Settings.types';
        ...
        <CardContent>
          <Box display="flex" justifyContent="space-between" alignItems="center">
            <Box>
              ...
              <Typography variant="body2" color="text.secondary">When enabled, the app will show a maintenance screen to all users.</Typography>
            </Box>
            <FormControlLabel
